...
public final class HttpClient {
    ...
    public HttpResponse post(String urlString, Map<String, String> requestHeaderFields, String data)
            throws IOException {
    ...
    public HttpResponse delete(String urlString, Map<String, String> requestHeaderFields, String data)
            throws IOException {
    ...
    public HttpResponse uploadFile(String urlString, String filePath) throws MalformedURLException, IOException {
        ...
        final byte[] REQUEST_START = ("--" + FILE_UPLOAD_BOUNDARY + "\r\n" + HttpHeaderField.CONTENT_DISPOSITION + ": "
                + HttpHeaderFieldValue.CONTENT_DISPOSITION_FORM_DATA + "; name=\"uploadedfile\";filename=\"" + filePath
        ...
        headerFields.put(HttpHeaderField.CONTENT_TYPE,
                HttpHeaderFieldValue.CONTENT_TYPE_MULTIPART_FORM_DATA + "; boundary=" + FILE_UPLOAD_BOUNDARY);
    ...
    public void downloadFile(String urlString, String filePath) throws MalformedURLException, IOException {
        ...
        try (HttpResponse response = sendRequest(request); OutputStream ouputStream = new FileOutputStream(filePath)) {
